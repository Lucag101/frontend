...
class Card extends React.Component<{'name':string, 'school': string, 'city' : string, 'abbrev' : string, 'state': string }>{
    render(){
    ...
    return (
        <div className="card" >
            ...
            <h3><b>{singleTeam.school} ( {singleTeam.abbrev} )</b></h3>
            <h5>Mascot : {singleTeam.name}</h5>
            <h5>Location : {singleTeam.city}, {singleTeam.state}</h5>
            <p></p><br></br>
        </div>
    );
    }
...
function TeamList(){
    return(
        <div>
            {teams.map(singleTeam => <Card {...singleTeam}/>)}
        </div>
    )
